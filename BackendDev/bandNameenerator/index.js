...
app.post("/submit", (req, res) => {
  ...
  const randomAdNum = Math.floor(Math.random() * adj.length);
  const randomNoNum = Math.floor(Math.random() * noun.length);
  const randomName = adj[randomAdNum] + " " + noun[randomNoNum];
  res.render("index.ejs", {
    randomNameGenerate: randomName,
  });
});
